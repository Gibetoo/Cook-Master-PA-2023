...
{
    $url = 'http://localhost/Projet-Annuel/Database/index?demande=cours_suivi&email='. $email; // On définit l'URL du serveur
    ...
    $response = json_decode($result, true); // On décode la réponse 
