...
function UpdateAbonnement($abonnement, $email)
{
    $url = 'http://127.0.0.1/Projet-Annuel/Database/index?demande=change_abo&email='. $email .'&abonnement=' . $abonnement; // On définit l'URL du serveur
