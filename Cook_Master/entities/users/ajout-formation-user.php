...
function AddFormationUser($id_fo, $email)
{
    $url = 'http://127.0.0.1/Projet-Annuel/Database/index?demande=add_formation_user&email='. $email .'&id_fo=' . $id_fo; // On définit l'URL du serveur
