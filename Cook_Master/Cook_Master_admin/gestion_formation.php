            ...
            <div class="container mt-4">
                ...
                <div class="row">
                    ...
                    foreach ($results as $formation) {
                        ...
                        echo '<h4 class="card-title">Nom de la Formation</h4>';
                        echo '<p class="card-text">' . $formation['nom_fo'] . '</p>';
                        echo '<h4 class="card-title">Description</h4>';
                        echo '<p class="card-text">' . $formation['description'] . '</p>';
                        echo '<h4 class="card-title">Prix</h4>';
                        ...
                        echo '<input type="hidden" name="id_fo" value="' . $formation['id_fo'] . '">';
