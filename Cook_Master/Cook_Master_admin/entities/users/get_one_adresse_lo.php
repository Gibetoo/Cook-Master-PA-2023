...
function getOneAdresse(string $id_adr): array
{

    $url = 'http://localhost/Projet-Annuel/Database/index?demande=one_adresse_lo&id_adr='. $id_adr; // On définit l'URL du serveur
