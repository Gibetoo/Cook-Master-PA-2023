...
function getOneCategerie(string $id_cat): array
{

    $url = 'http://localhost/Projet-Annuel/Database/index?demande=one_categorie&id_cat='. $id_cat; // On définit l'URL du serveur
