...
function sendbanprest($ban, $email_pres)
{
    $url = 'http://127.0.0.1/Projet-Annuel/Database/index?demande=change_ban_prest&email_prest=' . $email_pres . '&ban=' . $ban; // On définit l'URL du serveur
