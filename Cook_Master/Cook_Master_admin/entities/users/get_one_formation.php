...
function getOneFormation(string $id_fo) : array
{

    $url = 'http://localhost/Projet-Annuel/Database/index?demande=one_formation&id_fo=' . $id_fo; // On définit l'URL du serveur
