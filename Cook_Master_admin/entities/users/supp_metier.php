...
function sendsuppMetier($nom_metier)
{
    $url = 'http://127.0.0.1/Projet-Annuel/Database/index?demande=supp_metier&nom_metier=' . $nom_metier; // On définit l'URL du serveur
