...
function sendMod_droit($droit, $email)
{
    $url = 'http://127.0.0.1/Projet-Annuel/Database/index?demande=change_mod&email=' . $email . '&droit=' . $droit; // On définit l'URL du serveur
